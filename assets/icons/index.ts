...
export { default as AlertRed } from "./ic_alert_red.svg";
...
export { default as ChatActive } from "./ic_message_active.svg";
export { default as ChatDisabled } from "./ic_message_disabled.svg";
...
export { default as NoteDisabled } from "./ic_note_disabled.svg";
...
//pen icon
export { default as Pen } from "./ic_pen.svg";
...
// send icon
export { default as Send } from "./ic_send.svg";

// speaker icon
export { default as Speaker } from "./ic_speaker.svg";

// star icon
export { default as StarActive } from "./ic_star_active.svg";
export { default as StarDisabled } from "./ic_star_disabled.svg";

// trash icon
export { default as Trash } from "./ic_trash.svg";
export { default as TrashWhite } from "./ic_trash_white.svg";
...
// audio icon
export { default as Mic } from "./audio/ic_mic.svg";
export { default as Pause } from "./audio/ic_pause.svg";
export { default as Play } from "./audio/ic_play.svg";
export { default as Stop } from "./audio/ic_stop.svg";

// emotion icon
export { default as angry } from "./emotions/ic_angry.svg";
export { default as fear } from "./emotions/ic_fear.svg";
export { default as happy } from "./emotions/ic_happy.svg";
export { default as neutral } from "./emotions/ic_neutral.svg";
