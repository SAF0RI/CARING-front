...
import {
  emotionCharacteristics as emotionCharacteristicsMap,
  emotionKorMap,
  emotionRawColorMap,
...
export default function DiaryDetailScreen() {
  ...
  const emotionCharacteristics =
    emotionCharacteristicsMap[topEmotion ?? "unknown"];
          ...
          <View className="bg-white rounded-[20px] p-6 gap-y-6">
            ...
            <View className="flex-row items-center gap-x-2">
              <EmotionIconComponent
                emotion={
                  (topEmotion === "fear" ? "anxiety" : topEmotion) ?? "unknown"
                }
                isBig={false}
              />
